#I'm no where near smart enough for this, credit goes to Undead Zeratul for the original idea. 
...
fishCooked.add(<freshwatermobs:silexmeatcooked>);

# Raw Fish 
var rawFish = <ore:listAllfishraw>; 

rawFish.add(<freshwatermobs:silexmeatraw>); 
